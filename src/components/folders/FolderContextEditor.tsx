  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {previewMode ? (
          <div className="rounded-lg border border-border bg-muted/30 p-5 min-h-[300px] overflow-auto text-sm [&_*]:leading-relaxed">
            {content ? (
              <ReactMarkdown
                remarkPlugins={[remarkGfm]}
                components={{
                  h1: ({ children }) => (
                    <h1 className="mt-0 mb-4 text-xl font-bold tracking-tight border-b border-border pb-2 text-foreground">
                      {children}
                    </h1>
                  ),
                  h2: ({ children }) => (
                    <h2 className="mt-6 mb-3 text-lg font-semibold tracking-tight border-b border-border/80 pb-1.5 text-foreground">
                      {children}
                    </h2>
                  ),
                  h3: ({ children }) => (
                  ...
                  h4: ({ children }) => (
                    <h4 className="mt-4 mb-1.5 text-sm font-semibold text-foreground">
                      {children}
                    </h4>
                  ),
                  h5: ({ children }) => (
                    <h5 className="mt-3 mb-1 text-sm font-medium text-foreground">
                      {children}
                    </h5>
                  ),
                  h6: ({ children }) => (
                    <h6 className="mt-2 mb-1 text-xs font-medium text-muted-foreground uppercase tracking-wide">
                      {children}
                    </h6>
                  ),
                  p: ({ children }) => (
                    <p className="my-3 text-foreground first:mt-0 last:mb-0">
                      {children}
                    </p>
                  ),
                  ul: ({ children }) => (
                    <ul className="my-3 ml-5 list-disc space-y-1 text-foreground">
                      {children}
                    </ul>
                  ),
                  ol: ({ children }) => (
                    <ol className="my-3 ml-5 list-decimal space-y-1 text-foreground">
                      {children}
                    </ol>
                  ),
                  li: ({ children }) => (
                  ...
                  blockquote: ({ children }) => (
                    <blockquote className="my-3 border-l-4 border-primary/50 bg-muted/50 pl-4 py-1 italic text-muted-foreground">
                      {children}
                    </blockquote>
                  ),
                  code: ({ className, children, ...props }) => {
                    ...
                    return (
                      <code
                        className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-foreground border border-border/60"
                        {...props}
                      >
                        {children}
                      </code>
                  ...
                  pre: ({ children }) => (
                    <pre className="my-4 overflow-x-auto rounded-lg border border-border bg-muted/70 p-4 font-mono text-xs leading-relaxed text-foreground">
                      {children}
                    </pre>
                  ),
                  a: ({ href, children }) => (
